...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0">Tambah Paket Wisata</h2>
    ...
    <div class="card">
        <form action="<?= base_url('admin/wisata/simpan') ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nama_paket" class="form-control" value="<?= old('nama_paket') ?>" placeholder="Masukkan nama paket">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="kapasitas" class="form-control" value="<?= old('kapasitas') ?>" placeholder="Masukkan kapasitas">
            </div>
            <div class="mb-3">
                <label>Gambar</label>
